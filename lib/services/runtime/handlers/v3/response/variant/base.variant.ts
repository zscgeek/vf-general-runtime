...
export abstract class BaseVariant<Variant extends ResolvedVariant> {
  protected constructor(protected readonly rawVariant: Variant) {}
  ...
  public get condition(): BaseCondition | null {
    ...
    return buildCondition(this.rawVariant.condition);
  }

  public get attachments(): BaseAttachment[] {
    // $TODO$ - Convert to Attachment class
    return this.rawVariant.attachmentOrder.map((id) => buildAttachment(this.rawVariant.attachments[id]));
  }
}
