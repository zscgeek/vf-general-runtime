...
import { GeneralCommands, GeneralNodes, GeneralProject, GeneralVersionData } from '@voiceflow/general-types';
import { ServerDataApi } from '@voiceflow/runtime';

class RemoteDataAPI extends ServerDataApi<Program<GeneralNodes, GeneralCommands>, Version<GeneralVersionData>, GeneralProject> {
