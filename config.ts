...
const CONFIG: Config = {
  ...
  ERROR_RESPONSE_MS: Number(getOptionalProcessEnv('ERROR_RESPONSE_MS', (80 * 1000).toString())),
  ...
  ML_GATEWAY_ENDPOINT: getRequiredProcessEnv('ML_GATEWAY_ENDPOINT') || 'https://ml-gateway.test.e2e:8015/api/v1/nlp',
